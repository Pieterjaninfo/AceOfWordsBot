...
import static org.bytedeco.javacpp.opencv_text.OCRTesseract;
...
public class HSVimgFactory {
    ...
    private static int HUE_MIN = 20;		// The Hue,Saturation, Value/Brightness (HSV) values with minimum and maximum boundaries
    ...
    public static void main(String[] args) {
        ...
        BufferedImage image = Utils.loadImage("resources/test_mainimg2.png");
        BufferedImage img = image.getSubimage(20, 400, 1230, 160);
//        BufferedImage img = imgFac.getHSVImage(image);
        Utils.storeImage(img, "resources/test_mainimgADJUSTED_blackwhite.png");


        OCRTesseract instance = new OCRTesseract(null);
